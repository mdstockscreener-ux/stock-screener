...
export default function StockSearchSelect({ value, stockName, onChange, disabled }: StockSearchSelectProps): JSX.Element {
  const [query, setQuery] = useState('');
  const [results, setResults] = useState<EquityItem[]>([]);
